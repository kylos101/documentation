...
Some Pi have many HDMI ports, but not all support audio. [For example, on Rasberry Pi 4 Model B, HDMI0 supports audio, but not HDMI1.](https://www.raspberrypi.org/forums/viewtopic.php?p=1550253) 
